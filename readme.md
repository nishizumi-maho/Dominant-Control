# iRacing Control Interface

A control interface application for iRacing designed to assist drivers with accessibility needs and serve as an educational tool for understanding telemetry systems.
...
2. **Extract** the ZIP file to a location of your choice (e.g., `C:\iRacingControl\`)
3. **Run** `iRacingControlManager.exe`
